...
\chapter{Algoritmo de Transferencia de estilo}
    ...
    \section {Sintetizacion de texturas}
      \FIXME{AGREGAR INFO}
	...
	G_{i,j}^l = \sum_{k} F_{i,k}^l F_{j,k}^l
      ...
      \begin{equation}
       \hat x = \arg\min_X L_{total}
      \end{equation}


      \FIXME{``formalizar'' la solución de resolver el problema
        \eqref{eq:objetivo} como $\overrightarrow{x} = \arg\min_X L_{total}...$}
...
\section{Módulo de reconocimiento de estilo}
  ...
  \section{Elección del número de iteraciones empleando el módulo de reconocimiento}
	...
	\label{fig:golden_gate_scream}
	  ...
	  \begin{tabularx}{\textwidth}{@{}cXX@{}}
	  \begin{tabular}{cc}
	    \subfloat[Imagen de Estilo: The Scream]{\includegraphics[height=0.2\textheight]{./img/shipwreck.jpg}}
	    & \subfloat[Imagen de Contenido: Fotografia del Golden Gate]{\includegraphics[height=0.2\textheight]{./img/tubingen.jpg}}\\
