...
\fi
	...
	Al utilizar una red neuronal como modelo de aprendizaje automatico para clasificación, primero configurar la arquitectura de la red para luego comenzar con la etapa de aprendizaje.
...
\fi
  \section {Redes Neuronales Convolucionales}
      ...
      La principal diferencia es que la arquitectura de una red neuronal convolucional asume explícitamente que el conjunto de entrada son imágenes. Esto le permite codificar ciertas propiedades dentro de la arquitectura.
