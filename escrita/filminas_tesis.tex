...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \subfloat[\small Estilo]{\includegraphics[height=0.25\textheight]{./img/jhonson_style_candy.jpg}} \vspace{1.0cm}
      \subfloat[\small Contenido]{\includegraphics[height=0.25\textheight]{./img/jhonson_content_tower.jpg}} \vspace{1.0cm}
...
%  
  \begin{figure}[h]
    \begin{center}
      ...
      \subfloat[Clustering]{\includegraphics[height=0.35\textheight]{./img/stackoverflow_clustering.png}}
    \end{center}
  \end{figure}  
%  
\end{frame}
