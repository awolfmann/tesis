...
%Bishop
  ...
  \section{Aprendizaje Automático}
    ...
    \subsection{Representación de la Información en Aprendizaje Automático}
      ...
      Para representar una imagen, el método más sencillo es usar directamente el valor de los píxeles. Aunque este metodo no generaliza muy bien, puede mejorar utilizando 
	...
	Dado un modelo $F_{\theta}: \mathcal{X} {\rightarrow} \{1,..,K\}$ de parametros $\theta$. El objetivo del aprendizaje es poder estimar el valor de $\theta$, 
