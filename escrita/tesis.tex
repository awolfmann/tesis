...
\chapter{Elección Automatica de hiperparámetros para Transferencia de estilo}
  \section{Descripción del problema} \label{sec:descripcion}
    ...
    es necesario definir una serie de parametros previa a la ejecución del mismo. Entre estos, se encuentra el número de iteraciones, el cual fue seleccionado como el principal
    hiperparámetro a automatizarse en este trabajo.
...
\section{Reconocimiento de estilo}
  ...
  \section{Elección del número de iteraciones empleando el módulo de reconocimiento}
	...
	\end{figure}
      ...
      Al analizar la evolucion de los puntajes predichos por el clasificador nos encontramos con que el puntaje maximo de clasificación varia dependiendo de la imagen
...
\chapter{Conclusiones, Perspectivas y trabajos a futuro}
  \section{Conclusiones}
    ...
    clasifica estilos artisticos. Esta red inicialmente habia sido entrenada para clasificacion de objetos y luego mediante ajuste fino se reentreno para clasificar estilos.
    Al establecer una metrica cuantitativa de evaluación, el algoritmo libera al usuario de la responsabilidad de definir el numero de iteraciones, uno de los principales factores 
    ...
    de las mismas. Esto indica que en cierta forma, la evaluacion cualitativa logro ser plasmada en la metrica cuantitativa definida.
