...
%Bishop
  ...
  \section{Aprendizaje Automático}
	...
	\end{figure}
	  ...
	  \begin{figure}[ht]
	    \begin{center}
	     \includegraphics[width=0.8]{./img/stanford_linear_class.jpeg}
	    \end{center}
...
\fi
    ...
    \section {Ajuste fino} \label{sec:finetuning}
      ...
      \subsection{Redes Convolucionales Famosas y Modelos preentrenados}
...
\chapter{Algoritmo de Transferencia de estilo}
    ...
    \section{Sintesis \label{sec:sintesis}}
      ...
      El algoritmo presentado se reduce a un problema de optimización, donde se define una funcion de perdida que mide el error entre las representaciones de estilo y contenido 
      ...
      \FIXME{Revisar}
      en el cual el numero de iteraciones determina el grado de similitud entre la imagen generada con las imagenes elegidas para capturar el contenido y el estilo. 
      La gran influencia de dicho numero radica en que este determina cuanto se minimizara la funcion de perdida mediante el metodo de descenso por el gradiente.
      Al minimizar esta funcion de perdida se disminuye la distancia entre las representaciones de estilo y contenido de la imagen generada, con las respectivas representaciones
      de las imagenes de entrada.
