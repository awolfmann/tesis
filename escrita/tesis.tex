...
\fi
	...
	\subsubsection{Retropropagación del Error}
	  ...
	  o los resultados pueden ser acumulados a lo largo  del conjunto de entrenamiento en el caso de los métodos por lotes.
	  ...
	  \begin{figure}[h]
	    \begin{center}
	    \includegraphics[width=\linewidth]{./img/bishop_backpropagation.jpg}
	    \end{center}
	    \caption{ Ilustración del cálculo de $\delta_j$ oculta de la unidad j por retropropagación de la $\delta$ a partir de esas k unidades para las que la unidad $j$ envía 
	      ...
	      hacia atrásde la información de error.}
