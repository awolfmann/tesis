...
%https://en.wikipedia.org/wiki/Machine_learning
	...
	\paragraph {Recomendación basada en Usuarios}
	  \begin{algorithm}[h]
	    ...
	    \label{reco_user}
	    \begin{algorithmic}
	      \ForAll{item $i$ para el cual el usuario $u$ no tiene preferencia} 
		\ForAll{usuario $v$ que tiene preferencia por $i$} 
	...
	\paragraph {Recomendación basada en Items}
	  \begin{algorithm}[h]
	    ...
	    \begin{algorithmic}
	      \ForAll{item $i$ para el cual el usuario $u$ no tiene preferencia} 
		\ForAll{item $j$ que $u$ tiene una preferencia} 
	...
	\begin{figure}[h]
	  \includegraphics[scale=0.5]{./img/neuron.jpg}
