...
\chapter{Algoritmo de Transferencia de estilo}
    ...
    \section{Contexto}
      ...
      no fotorrealista \cite{Kyprianidis:ArtisticStylization}. Conceptualmente más relacionado con los métodos de uso de la textura de transferencia para lograr 
      el estilo artístico de transferencia \FIXME{Agregar Referencias Image Analogies etc}. Sin Embargo, estos enfoques anteriores se basan principalmente en técnicas no paramétricas 
